...
class Postagem(models.Model):
    ...
    descricao = models.TextField(null=True, blank=True)  # Mantém a descrição opcional
    imagem = models.ImageField(upload_to='desenhos/')
    usuario = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    curtidas = models.ManyToManyField(get_user_model(), related_name='curtidas', blank=True)  # Adiciona a relação de curtidas
    ...
    categoria = models.CharField(max_length=20, choices=CATEGORIAS, default='cartoon')
